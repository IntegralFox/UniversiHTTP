			...
			<section>
				...
				<form class="form-horizontal" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" name="assignmentName" required <?php if (isset($template['editing'])) echo "value=\"{$template['assignment']['assignment_name']}\""; ?>>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Assignment Description:</label>
						<div class="col-sm-7">
							<textarea class="form-control" name="assignmentDescription" rows="6" required><?php if (isset($template['editing'])) echo htmlentities($template['assignment']['assignment_description']); ?></textarea>
						</div>
					</div>
					<div class="form-group">
